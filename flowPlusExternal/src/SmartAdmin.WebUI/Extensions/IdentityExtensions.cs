...
namespace flowPlusExternal.Extensions
{
    public static class IdentityExtensions
    {
        ...
        [DebuggerStepThrough]
        public static async Task<IdentityResult> UpdateAsync<T>(this TPCoreProductionContext context, T model, string id) where T : class
        {
        ...
        [DebuggerStepThrough]
        public static async Task<IdentityResult> DeleteAsync<T>(this TPCoreProductionContext context, string id) where T : class
        {
            var entity = await context.FindAsync<T>(id);
