...
var initApp = (function (app) {
    ...
    app.resetSettings = function () {
        ...
        initApp.pushSettings("header-function-fixed nav-function-top nav-function-fixed");
...
var layouts = (function (setlayout) {
    initApp.pushSettings("header-function-fixed, nav-function-top");
...
var color = {
    primary: {
        ...
        _500: rgb2hex(myapp_config.mythemeColorProfileID.find('.color-primary-500').css('color')) || '#ba9765',
