...
namespace Data
{
    public partial class TPCoreProductionContext : IdentityDbContext
    {
        ...
        public virtual DbSet<ExtranetAccessLevel> ExtranetAccessLevels { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=FREDCPDBSSC0016\\\\\\\\SQL1, 50043;Initial Catalog=TPCoreProduction;Integrated Security=True;");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeeHoliday>(entity =>
            {
                ...
                entity.Property(e => e.TotalAnnualHolidays)
                    .HasColumnType("decimal(5, 1)")
                    .HasComputedColumnSql("([dbo].[funcGetAnnualHolidaysForEmployee]([EmployeeID],[PreviouslyWorkedDays],[TotalBaseAnnualHolidays],[Year],[MiscDays],[LoyaltyHolidaysTemp]))", false);
            ...
            modelBuilder.Entity<ExtranetAccessLevel>(entity =>
            {
